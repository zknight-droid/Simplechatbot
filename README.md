...
<h3 align="center">Simplechatbot</h3>

  <p align="center">
    Bot sederhana dengan menggunakan dataset.txt pribadi
  </p>
</div>
...
Chat Bot sederhana yang memungkinkan pengguna dapat berinteraksi dengan bot melalui terminal, bot ini menggunakan file dataset.txt sebagai responsenya
...
Untuk menjalankan chatbot, masukkan perintah
   ```js
   python chatBot.py
   ```
